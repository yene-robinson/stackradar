...
function AppInner() {
  ...
  return (
    <>
      ...
      <CommandPalette onConnectWallet={() => setWalletOpen(true)} onAddPosition={() => setAddPositionOpen(true)} />
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <Routes location={location}>
              ...
              <Route path="/dashboard" element={<Dashboard onOpenAddPosition={() => setAddPositionOpen(true)} onOpenWallet={() => setWalletOpen(true)} />} />
              <Route path="/positions" element={<Positions onOpenWallet={() => setWalletOpen(true)} />} />
              <Route path="/positions/:id" element={<PositionDetail />} />
              <Route path="/yield" element={<Yield onOpenWallet={() => setWalletOpen(true)} />} />
              <Route path="/analytics" element={<Analytics onOpenWallet={() => setWalletOpen(true)} />} />
